...
- Rules decisions already made: bodyguard picks by day and protects that night, and may not protect the same player two days in a row; hunter gets a 1h window after death then a random target; lynch is plurality with tie = no lynch; wolf kill is majority with tie = no kill; seer gets an immediate yes/no
